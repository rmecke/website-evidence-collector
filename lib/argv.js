...
var argv = require("yargs") // TODO use rather option('o', hash) syntax and define default top-level command
  ...
  .describe("ignore-https-errors", "Ignore certificate errors in browser")
  .boolean("ignore-https-errors")
  .default("ignore-https-errors", false)
  ...
  .describe("login-timeout", "page login timeout in ms (0 to disable)")
  .number("login-timeout")
  .default("login-timeout", 0)
  .nargs("login-timeout", 1)
